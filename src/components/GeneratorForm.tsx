...
import { Camera, Trash2, Sparkles, CheckCircle, ArrowRight, ShieldCheck } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto my-6 px-4">
      ...
      <div className="text-center space-y-2 mb-8 bg-amber-50/80 rounded-2xl p-6 border border-amber-200/90 shadow-sm">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-[#7A0C16] font-serif">
          आपली माहिती भरून ११ शुभेच्छा कार्ड्स तयार करा
        </h2>
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-amber-200/80 shadow-md p-6 sm:p-8">
